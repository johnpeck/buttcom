...
\begin{enumerate}
    ...
    \item Add a function for the command to call.\\
            You might like to put all the functions called by remote commands in their own module.  I don't worry too much about this, but I do try to prefix function names with ``cmd\_'' if those functions are called exclusively by remote commands.  This helps me remember that their arguments and return value are fixed.  
    \item Add an entry 
\end{enumerate}
