...
% The command array figure is created with a text file (command_array.txt)
% converted to a fig file using code2fig.sh.  Note that the standard
% fig2dev output won't work for eps output here, since the delta x extents
% aren't calculated properly.  You have to generate eps from the xfig gui.
\begin{listing}[ht]
    \begin{center}
