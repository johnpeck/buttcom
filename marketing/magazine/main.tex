...
I set up a logging system to help me understand how commands were being processed.  Figure \ref{fig:termgrab} shows the logger's output with all systems enabled for logging at all levels.
