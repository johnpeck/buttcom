...
* ------------------------ TODO list ----------------------------
* TODO Add the ISR logging level [2/4]
...
** TODO Revise the size section to reflect the new code size
** TODO Add a note in the watching the progress section about the new log level
...
* TODO When a cmd_ function takes no argument, make the argument uint16_t nonval
...
* TODO Add a new section -- using remote commands to set calibration values [10/11] :1day:
